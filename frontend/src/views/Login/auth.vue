  ...
  <div class="mainAuth">
     <Splitter class="splitter-custom" layout="horizontal">
        <SplitterPanel class="flex align-items-center justify-content-center no-resize" :size="65" > 
          <div>
            <img :src="imgLogo" alt="Logo" style="height: 700px;">
          </div>  
        </SplitterPanel>
        <SplitterPanel class="flex align-items-center justify-content-center no-resize" :size="35">
          <div class="formLogin">
            ...
            <div class="button">
              <Button label="Login" style="width: 100%;height: 35px;" />
            </div>
          </div>  
        </SplitterPanel>
    </Splitter>
...
.formLogin .username .inputUsername ,.formLogin .password .inputPassword{
  height: 45px;
  width: 100%;
}
.formLogin .button {
...
.formLogin .titleLogin label{
  font-size: 25px;
  font-weight: bold;
  margin-left: auto;
  margin-right: auto;
}
.formLogin .titleLogin{
  display: flex;
